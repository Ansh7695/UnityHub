...
import { Sparkles, LogIn, CheckCircle, ArrowRight, Github } from "lucide-react";
          ...
          <div className="py-8 text-center space-y-4">
            ...
            <div className="pt-2">
              <Link href="/hackathons">
                <Button className="px-6 py-2.5 bg-gradient-to-r from-primary to-purple-600">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <a href="#" className="text-primary hover:underline text-[11px]">Forgot?</a>
              </div>
              <input
                type="password"
                required
            ...
            <Button
              type="submit"
              className="w-full py-5 text-sm gap-2 bg-gradient-to-r from-primary to-purple-600 shadow-lg text-primary-foreground mt-2"
            >
