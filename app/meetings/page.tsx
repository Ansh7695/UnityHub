...
import { Video, Mic, MicOff, VideoOff, Users, Sparkles, Copy, Check, Play, ShieldCheck, PhoneOff, Monitor } from "lucide-react";
...
export default function VideoMeetingsPage() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8">
      {/* Header Banner */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-gradient-to-r from-primary/10 via-purple-600/10 to-indigo-600/10 p-6 sm:p-8 rounded-3xl border border-border/60">
        <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 bg-card border border-border/70 rounded-3xl p-6 sm:p-8 space-y-6 shadow-xl flex flex-col justify-between">
              ...
              <div className="space-y-4 text-xs">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl bg-secondary/80 border border-border text-foreground font-mono text-sm focus:outline-none focus:ring-2 focus:ring-primary/40"
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-3 rounded-xl bg-secondary/40 border border-border/40">
                  ...
                  <button
                    ...
                    className={`p-2 rounded-lg transition ${
                      startMuted ? "bg-primary text-primary-foreground" : "bg-secondary text-muted-foreground"
                    }`}
                  >
            ...
            <div className="space-y-3 pt-4 border-t border-border/60">
              <Button
                onClick={joinMeeting}
                className="w-full py-6 text-sm font-semibold gap-2 bg-gradient-to-r from-primary via-purple-600 to-indigo-600 hover:opacity-90 shadow-lg text-primary-foreground"
              >
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {publicRooms.map((room) => (
                <div
                  key={room.name}
                  className="bg-card border border-border/70 rounded-2xl p-5 hover:border-primary/50 transition-all flex flex-col justify-between space-y-4 group shadow-md"
                >
            ...
            <div className="p-6 rounded-2xl bg-secondary/40 border border-border/50 grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
              ...
              <div className="space-y-1">
                <Monitor className="w-6 h-6 text-purple-500 mx-auto" />
              ...
              <div className="space-y-1">
                <Users className="w-6 h-6 text-indigo-500 mx-auto" />
